...
% Vor der Abgabe komplett löschen: die Zeile \input{content/99-guideline}
...
\begin{itemize}
  \item Die Metadaten in \lstinline|content/00-metadata.tex| (Titel, Team, Betreuung,
        Schuljahr, Klasse).
  \item Die Beispielkapitel in \lstinline|content/|.
...
die Zeile \lstinline|\input{content/99-guideline}| zu löschen. Die Einträge
...
Vektorgrafiken haben gegenüber Screenshots mehrere Vorteile:

\begin{itemize}
  \item Sie können jederzeit editiert werden.
  \item Sie lassen sich beliebig skalieren, ohne unscharf zu werden.
  \item Alle Grafiken können einheitlich vergrößert oder verkleinert werden.
...
Die Titelseite wird vollständig aus \lstinline|content/00-metadata.tex| erzeugt. Dort
sind einzutragen:
...
\lstinline|content/10-problem-statement.tex| das Scan-PDF eingebunden.
...
Hilfsmittel. Dafür ist \lstinline|content/90-ai-tools.tex| vorgesehen.
